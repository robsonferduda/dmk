...
Route::get('msg-filiacao', function () {
    return view('errors/msg_filiacao');
})->name('msg-filiacao');
Route::get('correspondente', function () {
    return view('correspondente/cadastro');
})->name('correspondente');
Route::get('correspondente/senha/{correspondente}', 'CorrespondenteController@cadastrarSenha')->name('cadastrar.senha');
Route::get('correspondente/login', function () {
    return view('auth/correspondente');
})->name('autenticacao.correspondente');
