...
Route::get('cadastro', function () {    return view('conta/novo');})->name('cadastro');
...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::get("saida/{conta}/{id}/anexo/{file}", "AnexoFinanceiroController@showComprovante");
    ...
    Route::get('cliente/acessos/{id}', 'ClienteController@acessos');
    ...
    Route::get('cliente/relatorio', 'RelatorioClienteController@index');
    ...
    Route::get('cliente/processos/editar/{id}', 'ClienteProcessoController@editar');
    ...
    Route::get('autocompleteCorrespondenteDeletedToo', 'CorrespondenteController@searchDeletedToo');
    ...
    Route::get('processos/pendentes', 'ProcessoController@pendentes');
    Route::get('processos/pendentes/notificar', 'ProcessoController@notificarPendentes');
    ...
    Route::get('processos/atualiza/documentacao-cliente/{id}', 'ProcessoController@atualizaDocumentacaoCliente');
    ...
    Route::post('processos/alterar-status', 'ProcessoController@alterarStatus');
    Route::post('processo/informar-link-audiencia', 'ProcessoController@informarLinkAudiencia');
    Route::post('processo/atualizar-audiencia', 'ProcessoController@atualizarAudiencia');
    Route::post('processo/atualizar-checkin', 'ProcessoController@atualizarCheck');
    Route::post('processo/atualizar-checkin-escritorio', 'ProcessoController@atualizarCheckinEscritorio');
    Route::post('processo/atualizar-documento-representacao', 'ProcessoController@atualizarDocumentoRepresentacao');
    ...
    Route::get('correspondente/whatsapp/checkin', 'CorrespondenteController@whatsappCheckin');
    ...
    Route::get('correspondente/todos', function () {
        return view('correspondente/todos');
    });
...
Route::get('correspondente/acompanhamento/{id}', 'CorrespondenteController@acompanhamento')->name('processo.correspondente');
    ...
    Route::get('correspondente/pagamentos/relatorio-excel',           'CorrespondentePagamentoController@relatorioExcel');
    ...
    Route::post('correspondente/pagamentos/reenviar-aprovacao-todos', 'CorrespondentePagamentoController@reenviarAprovacaoTodos');
    ...
    Route::post('correspondente/pagamentos/{id}/atualizar-dados-bancarios', 'CorrespondentePagamentoController@atualizarDadosBancarios');
    ...
    Route::get('financeiro/dashboard', function () {
