...
class ContaAtivarNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->action(Lang::getFromJson('Aceitar convite'), url(config('app.url').route('correspondente.filiacao', ['token' => 4444], false)))
