...
class ClienteController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $resultados = Cliente::where('nm_razao_social_cli', 'ilike', '%'. $search. '%')->where('cd_conta_con',$this->conta)->orWhere('nm_fantasia_cli', 'ilike', '%'. $search. '%')->orWhere('nu_cliente_cli', 'ilike', '%'. $search. '%')->select('cd_entidade_ete','cd_cliente_cli','nm_razao_social_cli','nm_fantasia_cli','taxa_imposto_cli','nu_cliente_cli')->get();
