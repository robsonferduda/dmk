        ...
        <article class="col-sm-12 col-md-12 col-lg-12">
            <div class="jarviswidget jarviswidget-sortable">
                ...
                <div role="content">
                    <div class="widget-body no-padding">
                        {!! Form::open(['id' => 'frm_add_despesas', 'url' => (!empty($despesa)) ? ['despesas',$despesa->cd_despesa_des] : 'despesas', 'class' => 'smart-form', 'method' => (!empty($despesa)) ? 'PUT' : 'POST','files' => true]) !!}
                            ...
                            <fieldset>
                                <div class="row">
                                    <input type="hidden" name="id_despesa" id="id_despesa" value="{{ (!empty($despesa)) ? $despesa->cd_despesa_des : '127' }}">
                ...
                <div class="button-bar">
                    ...
                    <button type="button" class="btn btn-info start-all btn-upload-plugin">
                        <i class="fa fa-arrow-circle-o-up"></i> Enviar Todos
                    </button>
        ...
        $(document).ready(function() { 
           ...
           $('#filepicker').filePicker({
            ...
            .on('done.filepicker', function (e, data) {
                $('#id_despesa').val(data.files[0].id);
            });
