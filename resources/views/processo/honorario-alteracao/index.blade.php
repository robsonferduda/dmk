...
<div id="ribbon">
    <ol class="breadcrumb">
        ...
        <li>Pedidos de Alteração de Honorário</li>
    </ol>
</div>
<div id="content">
    <div class="row">
        <div class="hidden-xs hidden-sm col-sm-12 col-md-6 col-lg-5">
            <h1 class="page-title txt-color-blueDark">
                <i class="fa-fw fa fa-money"></i> Processos <span>> Pedidos de Alteração de Honorário</span>
            </h1>
        </div>
    </div>
    <div class="row">
            ...
            <article class="col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
                <div class="jarviswidget jarviswidget-sortable">
                    <header role="heading" class="ui-sortable-handle">
                        ...
                        <h2>Pedidos de Alteração de Honorário</h2>
                    </header>
                            ...
                            <tbody>
                                @forelse($alteracoes as $alteracao)
                                    <tr>
                                        ...
                                        <td>
                                            @if($alteracao->isPendente())
                                                <a href="{{ url('processos/honorario-alteracao/'.$alteracao->cd_taxa_honorario_alteracao_tha) }}"
                                                   class="btn btn-primary btn-xs">
                                                    <i class="fa fa-eye"></i> Analisar
                                                </a>
                                            @else
                                                <a href="{{ url('processos/honorario-alteracao/'.$alteracao->cd_taxa_honorario_alteracao_tha) }}"
