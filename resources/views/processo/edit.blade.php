...
<div id="content">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 boxBtnTopo">
            ...
            <a data-toggle="modal" href="{{ url('processos/detalhes/'.$processo->cd_processo_pro) }}" class="btn btn-default pull-right header-btn"><i class="fa fa-file-text-o fa-lg"></i> Detalhes</a>     
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
