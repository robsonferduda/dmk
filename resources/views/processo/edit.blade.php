...
<div id="content">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 boxBtnTopo">
            ...
            <a href="{{ url('processos/acompanhamento/'.safe_encrypt($processo->cd_processo_pro)) }}" class="btn btn-default pull-right header-btn"><i class="fa fa-calendar fa-lg"></i> Acompanhamento</a> 
                            ...
                            <fieldset>
                                <div class="row" style=""> 
                                    <section class="col col-md-12 col-lg-12">
                                        ...
                                        <label class="input">
                                            <input type="text" class="form-control" placeholder="Link da Audiência" name="ds_link_audiencia_pro" id="ds_link_audiencia_pro" value="{{ ($processo->ds_link_audiencia_pro) ? $processo->ds_link_audiencia_pro : old('ds_link_audiencia_pro') }}">
                                        </label>
                                    </section> 
                                </div>
