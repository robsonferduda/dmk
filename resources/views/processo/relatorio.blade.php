...
<div id="content">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 boxBtnTopo">
            ...
            <a data-toggle="modal" href="{{ url('processos/acompanhamento/'.safe_encrypt($processo->cd_processo_pro)) }}" class="btn btn-default pull-right"><i class="fa fa-calendar fa-lg"></i> Acompanhamento</a>
