...
{{--
    [TIMEMARK - EM TESTES]
    Cópia da view processo/acompanhar.blade.php usada como sandbox
    para a feature Timemark (comprovações com data/hora, GPS e logo
    enviadas pelo correspondente).
    Em caso de bug, a tela oficial em
    processos/acompanhamento/{id} continua intacta.
--}}
<div class="alert alert-warning" style="margin:10px 15px 0 15px;">
    <i class="fa fa-flask"></i>
    <strong>Versão em testes (Timemark):</strong>
    em caso de problema, utilize o
    <a href="{{ url('processos/acompanhamento/'.safe_encrypt($processo->cd_processo_pro)) }}">acompanhamento padrão</a>.
</div>

{{-- Bloco Timemark - Comprovações --}}
            ...
            <div class="jarviswidget jarviswidget-color-blueDark"
                ...
                <div>
                    <div class="widget-body">
                        {{-- Captura de nova comprovação (correspondente em campo) --}}
                        <div class="row" style="margin-bottom:15px;">
                            <div class="col-sm-12">
                                ...
                                <input type="text" id="tm-observacao" class="form-control" placeholder="Observação (opcional)" style="display:inline-block;width:auto;max-width:400px;margin-left:10px;">
                                            ...
                                            <div class="caption">
                                                ...
                                                @if($cmp->nu_latitude_pcm && $cmp->nu_longitude_pcm)
                                                    <a class="btn btn-xs btn-default"
                                                       ...
                                                       target="_blank">
                                                        <i class="fa fa-external-link"></i> Ver no mapa
                                                    </a>
                                                @endif
                                            </div>
                                        </div>
    ...
    input.addEventListener('change', function () {
        ...
        getPosicao().then(function (pos) {
            ...
            .then(function (data) {
                ...
                var rowEl = galeria.querySelector('.row');
                if (!rowEl) {
                ...
                col.innerHTML =
                    '<div class="thumbnail">' +
                        ...
                        '<div class="caption">' +
                            ...
                            (c.nu_latitude_pcm && c.nu_longitude_pcm
                                ? '<a class="btn btn-xs btn-default" target="_blank" href="https://maps.google.com/?q=' +
                                  c.nu_latitude_pcm + ',' + c.nu_longitude_pcm + '"><i class="fa fa-external-link"></i> Ver no mapa</a>'
                                : '') +
                        '</div>' +
                    '</div>';
    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <article class="col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
                    <div class="well">
                        @include('processo.acompanhar.chat-correspondente')
                        @include('processo.acompanhar.chat-escritorio')
                        @include('processo.acompanhar.chat-cliente')
                            ...
                            <div class="well">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="active">
                                        <a href="#tab-notificacoes" aria-controls="tab-notificacoes" role="tab" data-toggle="tab">
                                            <i class="fa fa-send marginBottom5"></i> Histórico de Notificações
                                            @if($processo->notificacoes->count())
                                                <span class="badge">{{ $processo->notificacoes->count() }}</span>
                                            @endif
                                        </a>
                                    </li>
                                    <li role="presentation">
                                        <a href="#tab-historico" aria-controls="tab-historico" role="tab" data-toggle="tab">
                                            <i class="fa fa-clock-o marginBottom5"></i> Histórico do Processo
                                        </a>
                                    </li>
                                </ul>

                                <div class="tab-content" style="padding-top: 12px;">
                                    <div role="tabpanel" class="tab-pane active" id="tab-notificacoes">
                            ...
                            <div class="row box-cadastro">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Link da Audiência" name="link_audiencia" id="link_audiencia" value="{{ ($processo->ds_link_audiencia_pro) ? $processo->ds_link_audiencia_pro : '' }}">
                                        <div id="msg_error_preposto" class="text-danger"></div>
                                    </div>    
                                </div>
                            </div>
