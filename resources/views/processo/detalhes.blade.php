        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-7 box-button">
            <div class="boxBtnTopo sub-box-button">
                @role('administrator|colaborador') 
                    ...
                    <a title="Acompanhamento" href="{{ url('processos/acompanhamento/'.safe_encrypt($processo->cd_processo_pro)) }}" class="btn btn-default pull-right header-btn"><i class="fa fa-calendar fa-lg"></i><span class="hidden-xs hidden-sm hidden-md">Acompanhamento</span></a> 
