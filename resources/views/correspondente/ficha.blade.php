                                    ...
                                    <fieldset>
                                         <section>
                                            <div class="inline-group">
                                                ...
                                                <label class="radio">
                                                    <input type="radio" class="tipo-pessoa" name="cd_tipo_pessoa_tpp" value="1" {{ (!($correspondente->cd_tipo_pessoa_tpp )) ? 'checked="checked"' : '' }} {{ ($correspondente->cd_tipo_pessoa_tpp == 1) ? 'checked="checked"' : '' }}>
                                ...
                                <div class="col col-6">
                                    ...
                                    <div class="row" style="margin: 0; padding: 5px 13px;">
                                            ...
                                            <table id="tabelaFone" class="table table-bordered">
                                                ...
                                                <tbody>
                                                    @foreach($correspondente->entidade->fone()->get()->sortBy('cd_fone_fon') as $fone)
                                                        <tr>
                                        ...
                                        <table id="tabelaEmail" class="table table-bordered">
                                            ...
                                            <tbody>
                                                @foreach($correspondente->entidade->enderecoEletronico()->get() as $email)
                                                    <tr>
                                                        <td data-tipo="{{ $email->tipo->cd_tipo_endereco_eletronico_tee }}" class="center">{{ $email->tipo->dc_tipo_endereco_eletronico_tee }}</td>
                                                            ...
                                                            @foreach($correspondente->entidade->banco()->get() as $banco)
                                                               <tr>
                                                                    ...
                                                                    <td class="center">
                                                                        ...
                                                                        <span>
                                                                            <a class="excluirDadosBancariosBase btnContaExcluir" style="cursor: pointer;" data-codigo="{{ $banco->cd_dados_bancarios_dba }}"><i class="fa fa-trash"></i></a>
                                                                        </span>
                                                                    </td>
                                                                </tr>
                                                            @endforeach     
