                                ...
                                @foreach($correspondetes as $correspondente)
                                    <tr>
                                        ...
                                        <td class="center">
                                            ...
                                            <a title="Editar" class="btn btn-primary btn-xs" href="{{ url('correspondente/ficha/'.$correspondente->contaCorrespondente->cd_correspondente_cor) }}"><i class="fa fa-edit"></i> </a>
