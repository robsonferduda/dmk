    ...
    <div class="card">
            ...
            <div class="row">
                <div class="col-md-8">
                    <h4 class="card-title">
                        ...
                        Atividades — {{ $correspondente->nm_conta_correspondente_ccr }}
                    </h4>
                </div>
                <div class="col-md-4">
        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-11">
                    <h5 class="mb-0"><strong>{{ $correspondente->nm_conta_correspondente_ccr }}</strong></h5>
                    ...
                    @if($correspondente->obs_ccr)
                        <p class="text-muted mt-1 mb-0" style="font-size:13px;"><i class="fa fa-comment-o"></i> {{ $correspondente->obs_ccr }}</p>
                    @endif
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="padding:0;">
                            @if($processosAtivos->isEmpty())
                                <p class="text-muted text-center p-3">Nenhum processo ativo no momento.</p>
                            @else
                                <table class="table table-hover table-condensed mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        @php
                                            $prazo = $processo->dt_prazo_fatal_pro
                                                ? \Carbon\Carbon::parse($processo->dt_prazo_fatal_pro)
                                                : null;
                                            $urgente = $prazo && $prazo->isPast();
                                        @endphp
                                        <tr class="{{ $urgente ? 'bg-danger' : '' }}">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="padding:0;">
                            @if($ultimosAcessos->isEmpty())
                                <p class="text-muted text-center p-3">Nenhum acesso registrado.</p>
                            @else
