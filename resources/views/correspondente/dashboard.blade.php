                                ...
                                @forelse($mensagens_pendentes as $mensagem)
                                    <li class="message margin-bottom-10">
                                        ...
                                        <div class="message-text">
                                            <a href="{{ url('processos/acompanhamento/'.safe_encrypt($mensagem->cd_processo_pro)) }}" class="username txt-color-blueDark">Processo {{ ($mensagem->processo) ? $mensagem->processo->nu_processo_pro : '' }}</a> 
                                            <span class="font-xs">
