                ...
                <article class="col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
                    <div class="well">                      
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <h4><i class="fa fa-comments-o marginBottom5"></i> Chat Escritório <span class="text-info">O Escritório será notificado por email sobre novas mensagens</span></h4>
                            <div class="messaging">
                                <div class="inbox_msg">
                                    <div class="mesgs">
                    ...
                    <article class="col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable">
                        <div class="well">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <h4><i class="fa fa-comments-o marginBottom5"></i> Mensagens com o Escritório <span class="text-info">O escritório receberá suas mensagens por este canal</span></h4>
                                <div class="messaging">
                                    <div class="inbox_msg">
                                        <div class="mesgs">
