    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 box-button-xs" >
            <div class="sub-box-button-xs">
                <a  title="Novo" data-toggle="modal" href="{{ url('cliente/processos/novo') }}" class="btn btn-success pull-right header-btn"><i class="fa fa-plus fa-lg"></i> Novo</a>
                <a title="Pauta Online" href="{{ url('cliente/pauta') }}" style="margin-right: 5px" class="btn btn-default pull-right header-btn btnMargin"><i class="fa fa-globe fa-lg"></i> Pauta Online</a>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $.ajax({
                ...
                url: host+'/api/cliente/processo/andamento',
                type: 'GET',
                        ...
                        .append('<div class="well box-acompanhamento" style="padding: 10px 15px; border: none; background: '+data.background+';">'+
                            ...
                            '<div class="row box-processo">'+
                                ...
                                '<div class="hidden-xs col-sm-12 col-md-12 pull-right">'+
                                    ...
                                    '<a title="Cancelar" class="cancelar_registro icone-acompanhamento" href="../processos/cancelar/'+data.hash+'"><i class="fa fa-ban"></i> Cancelar</a>'+
                                ...
                                '<div class="hidden-md hidden-sm hidden-lg col-md-6">'+
                                    ...
                                    '<a title="Cancelar" class="cancelar_registro icone-acompanhamento" href="href="../processos/cancelar/'+data.hash+'""><i class="fa fa-ban"></i> </a>'+
                                    '<span class="pull-right processo-user">Cadastrado em '+data.created_at+' por <strong>'+user_cadastro+'</strong></span>'+
                                '</div>'+
                            '</div>'+
                        '</div>');
