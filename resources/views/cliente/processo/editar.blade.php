...
<div id="ribbon">
    <ol class="breadcrumb">
        ...
        <li><a href="{{ url('clientes/processos') }}">Processos</a></li>
        <li>Editar</li>
    </ol>
</div>
<div id="content">
                            ...
                            <fieldset>
                                <div class="row">
                                    <section class="col col-4">
                                        ...
                                        <label class="input">
                                           <input class="dt_solicitacao_pro" placeholder="___ /___ /___" type="text" name="dt_solicitacao_pro" value="{{ old('dt_solicitacao_pro') ? old('dt_solicitacao_pro') : ($processo->dt_solicitacao_pro ? \Carbon\Carbon::parse($processo->dt_solicitacao_pro)->format('d/m/Y') : '') }}">
                                        </label>
                                    </section>                                     
                                    <section class="col col-4">
                                        <label class="label">Data Prazo Fatal<span class="text-danger">*</span></label>
                                        <label class="input">
                                           <input class="dt_prazo_fatal_pro" placeholder="___ /___ /___" type="text" name="dt_prazo_fatal_pro" value="{{ old('dt_prazo_fatal_pro') ? old('dt_prazo_fatal_pro') : ($processo->dt_prazo_fatal_pro ? \Carbon\Carbon::parse($processo->dt_prazo_fatal_pro)->format('d/m/Y') : '') }}">
                                        </label>
                                    </section> 
                                    <section class="col col-4">
