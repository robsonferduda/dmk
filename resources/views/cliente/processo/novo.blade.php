                                    ...
                                    <section class="col col-xs-12 col-sm-12">
                                        ...
                                        <select id="cd_area_direito_ado" name="cd_area_direito_ado" class="select2">
                                            ...
                                            @foreach($areas as $area)
                                                <option value="{{ $area->cd_area_direito_ado }}" {{ old('cd_area_direito_ado') == $area->cd_area_direito_ado ? 'selected' : '' }}>{{ $area->dc_area_direito_ado }}</option>
                                            @endforeach
                                        </select>
                                    </section>
                                </div>
