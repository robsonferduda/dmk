...
<div id="ribbon">
    <ol class="breadcrumb">
        ...
        <li><a href="{{ url('cliente/contatos/'.$cliente->cd_entidade_ete) }}">Contatos</a></li>
        <li>Novo</li>
    </ol>
</div>
<div id="content">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <h1 class="page-title txt-color-blueDark">
                <i class="fa-fw fa fa-group"></i> Clientes <span>> Contatos</span> <span>> Novo</span>
            </h1>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 boxBtnTopo">
            <a data-toggle="modal" href="{{ url('cliente/contatos/'.$cliente->cd_entidade_ete) }}" class="btn btn-default pull-right header-btn btnMargin"><i class="fa fa-book fa-lg"></i> Listar Contatos</a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="jarviswidget jarviswidget-sortable">
                ...
                <div role="content">
                    <div class="widget-body no-padding">
                        {!! Form::open(['id' => 'frm-add-contato', 'url' => ['cliente/contato/novo',$cliente->cd_entidade_ete], 'class' => 'smart-form']) !!}
