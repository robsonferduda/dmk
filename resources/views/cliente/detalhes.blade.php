                        ...
                        <div class="col-md-6">
                            <div class="col-md-12">
                                <fieldset style="margin-bottom: 15px;">
                                    ...
                                    <div class="row" style="margin-left: 5px;">
                                        @if($cliente->entidade and $cliente->entidade->endereco()->first() and !is_null($cliente->entidade->endereco()->first()->dc_logradouro_ede))
                                            <p>
                                                <ul class="list-unstyled">
                                                    <li>
                        ...
                        <div class="col-md-6">
                            <div class="col-md-12">
                                <fieldset style="margin-bottom: 15px;">
                                    ...
                                    <div class="row" style="margin-left: 5px;">
                                        @if($cliente->entidade and count($cliente->entidade->fone()->get()) > 0)
                        ...
                        <div class="col-md-6">
                            <div class="col-md-12">
                                <fieldset style="margin-bottom: 15px;">
                                    ...
                                    <div class="row" style="margin-left: 5px;">
                                        @if($cliente->entidade and count($cliente->entidade->enderecoEletronico()->get()) > 0)
