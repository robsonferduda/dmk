                                    ...
                                    <div class="row" style="margin-left: 5px;">
                                        <p>
                                            <ul class="list-unstyled">
                                                ...
                                                <li>
                                                    <strong>Cidade/Estado: </strong> {{ ($cliente->entidade->endereco()->first()) ? $cliente->entidade->endereco()->first()->cidade->nm_cidade_cde .'/'. $cliente->entidade->endereco()->first()->cidade->estado->nm_estado_est : '' }}
                                                </li>
                                            </ul>
                                        </p> 
                                    </div>
