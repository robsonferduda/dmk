                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <section class="col col-6">
                                            ...
                                            <label class="input">
                                                <input type="text" name="ds_site_cli" id="ds_site_cli" value="{{ old('ds_site_cli') }}">
                                            </label>
                                        </section>
                                    </div>                        
                                    ...
                                    <div class="row">
                                        ...
                                        <section class="col col-3">
                                            ...
                                            <label class="input">
                                                <input type="text" name="oab" placeholder="OAB" value="{{ old('oab') }}">
                                                </label>
                                        </section> 
                                    ...
                                    <section>
                                        <div class="onoffswitch-container" style="margin-left: 0px;">
                                            ...
                                            <span class="onoffswitch">
                                                <input type="checkbox" class="onoffswitch-checkbox" name="fl_ativo_cli" value="S" id="fl_ativo_cli" {{ (old('fl_ativo_cli') and old('fl_ativo_cli') == 'S') ? 'checked' : '' }}>
                            ...
                            <fieldset>
                                <div class="row">
                                    ...
                                    <section class="col col-md-4">
                                        ...
                                        <label class="input">
                                            <input type="text" name="email_user" id="email_user" value="{{ old('email_user') }}">
                                        </label>
                                    </section> 
                                    ...
                                    <section class="col col-md-4">
                                        ...
                                        <label class="input">
                                            <input type="password" name="senha_user" id="senha_user" value="{{ old('senha_user') }}">
                                        </label>
                                    </section> 
