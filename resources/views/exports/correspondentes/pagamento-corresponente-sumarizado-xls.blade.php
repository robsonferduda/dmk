<table>
    ...
    <tbody>
        ...
        @endphp
            ...
            @foreach ($correspondente['registros_bancarios'] as $dadosb)
               
                <tr>       
                @if($primeira_passada)
                    <td rowspan="{{ count($correspondente['registros_bancarios']) }}" style="border: 1px hair #000000;vertical-align: center;{{ ($i%2 == 0) ? 'background-color:#CDE5CD' : '' }}" >
                        {{ $correspondente['razao_social'] }}
                    </td>
        ...
        @endforeach   
        <tr>
            <td style="border: 1px hair #000000;text-align: center;vertical-align: center;">TOTAL</td>    
