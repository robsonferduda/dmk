...
<html lang="pt-br">
    <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-170624377-1"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'UA-170624377-1');
        </script>
    ...
    <body class="{{ (Session::get('menu_minify') == 'on') ? 'minified' : '' }}" id='body-principal'>
        <header id="header">
            <div id="logo-group">
                <span id="logo"> <img style="width: 25px;" src="{{ asset('img/legal.png') }}" alt="Logo"> </span>
                ...
                <ul>   
                    ...
                    @role('cliente') 
                        <li class="menu {{ (Session::get('menu_pai') == 'calendario') ? 'open' : '' }}">
                            <a href="{{ url('cliente/calendario') }}" title="blank_"><i class="fa fa-lg fa-fw  fa-calendar"></i> <span class="menu-item-parent">Calendário</span></a>
                        </li> 
                    ...
                    <li class="menu {{ (Session::get('menu_pai') == 'financeiro') ? 'open' : '' }}">
                        ...
                        <ul style="{{ (Session::get('menu_pai') == 'financeiro') ? 'display: block;' : 'display: none;' }}">
                            ...
                            @endcan
                            @can('correspondente.relatorios')
                                <li class="{{ (Session::get('item_pai') == 'financeiro.correspondentes') ? 'active' : '' }}">
                    ...
                    @role('correspondente')    
                        ...
                        <li class="menu {{ (Session::get('menu_pai') == 'processos') ? 'open' : '' }}">
                            ...
                            <ul style="{{ (Session::get('menu_pai') == 'processos') ? 'display: block;' : 'display: none;' }}">
                                <li>
                                    <a href="{{ url('correspondente/check-in') }}" title="Check-In"><span class="menu-item-parent">Check-In</span></a>
                                </li>
                                <li>
        ...
        <div class="modal fade modal_top_alto" id="modal_exclusao_msg" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="modal_exclusao_msg" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
